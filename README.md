...
## About Repository 
This repository contains the information of PostgreSQL Commands for Data Analytics. I have also add the project named SuperMart_Project which contains the basic command running of PostgreSQL. I HAVE ADDED DETAILED EXPLANATION OF THE EACH AND EVERY QUERY IN BOTH OF THE FILES. THIS IS DONE ON PgAdmin. I would like to thank Star-tech Academy. 
